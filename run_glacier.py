...
bedFilename = 'bed.tif'
bedErrFilename = 'bedError.tif'
demGIMPfilename = 'gimpdem_90m.tif'
demGIMPerror = 10.
...
# GIMP DEM
print(' -> GIMP DEM')
gl.new_dataset(name='GIMP DEM', type='raster', filename=demGIMPfilename, uncertainty=demGIMPerror, nodataValues=[-9999.0, 0.0])
...
plt.plot(gl.centerline.distance, gl.datasets['GIMP DEM'].get_z(), 'b.-')
plt.show()
...
gl.Pe('bed', 'GIMP DEM', 'Pe', sea_level=sea_level)
